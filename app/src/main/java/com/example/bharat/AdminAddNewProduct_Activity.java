...
public class AdminAddNewProduct_Activity extends AppCompatActivity {
    ...
    private String CategoryName, Pname, Pdescription, Pprice, Pseller, Pcountry, saveCurrentDate, saveCurrentTime, Pgtin;
    private Button Add_new_product_btn, scan_btn;
    private EditText Input_product_name, Input_product_description, Input_product_price, Input_product_seller, Input_product_country, Input_product_gtin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Input_product_gtin = (EditText) findViewById(R.id.product_gtin);
    ...
    private void ValidateProductData()
    {
        ...
        Pgtin = Input_product_gtin.getText().toString();
        ...
        else if (!TextUtils.equals(Pcountry,"INDIA"))
        {
            Toast.makeText(this, "Product Country name INDIA is mandatory", Toast.LENGTH_SHORT).show();
        }

        else if (TextUtils.isEmpty(Pgtin) || !TextUtils.equals(Pgtin.substring(0,3),"890"))
        {
            Toast.makeText(this, "Product Country code INDIA is mandatory", Toast.LENGTH_SHORT).show();
        }
