...
public class Register_Activity extends AppCompatActivity {
    ...
    private void CreateAccount() {
        ...
        else if(TextUtils.getTrimmedLength(mobile)!=10 || TextUtils.isEmpty(mobile))
        {
            Toast.makeText(this, "Please Enter your #Mobile_Number",Toast.LENGTH_SHORT).show();
        }

        else if(TextUtils.isEmpty(password) || TextUtils.getTrimmedLength(password)<9)
        {
            Toast.makeText(this, "Please Enter your #Password more than 8 characters",Toast.LENGTH_SHORT).show();
        }
